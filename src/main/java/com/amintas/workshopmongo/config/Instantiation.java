...
import com.amintas.workshopmongo.dto.AuthorDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu viagem", "Vou viajar agora para São Paulo, abraços", new AuthorDTO(maria));
